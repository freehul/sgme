...
describe('registerTools 注册（T-86 扩充 → SGME 1.2.2 对齐）', () => {
  it('注册全部 40 个工具（9 旧 + 9 新 + inject + 5 技能层 + 15 对齐 + conversation_search）', () => {
    ...
    for (const name of [
      ...
      // 技能层（T-111，ST-36 读侧）
      'skill_search', 'skill_digest', 'skill_get', 'skill_list', 'skill_coldstart',
      // SGME 1.2.2 对齐（15）：聚合答案/健康/统计/信号/配置/提炼/技能写侧
      'answer', 'memory_unreject', 'health', 'stats',
      'signal_clear', 'wiki_evolve_trigger',

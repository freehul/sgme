...
<img src="assets/selling-point-11-persona-insight.png" alt="人格洞察" width="800"/>
...
<img src="assets/selling-point-04-wiki.png" alt="共享知识库" width="800"/>
...
# 模型 Key（可选，支持免费档）：提炼主链 agnes-2.5-flash（免费）→ 硅基流动 DeepSeek-V4-Flash（免费备用；zhipu 已于 2026-08-29 移出链，B121）；向量检索硅基流动 BAAI/bge-m3（零费用）。
